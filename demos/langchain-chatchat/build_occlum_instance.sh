...
function build_instance()
{
    ...
    rm -rf image
    copy_bom -f ../rag.yaml --root image --include-dir /opt/occlum/etc/template

    new_json="$(jq '.resource_limits.user_space_size = "80GB" |
                    ...
                    .env.default += ["STREAMLIT_SERVER_FILE_WATCHER_TYPE=none"] |
