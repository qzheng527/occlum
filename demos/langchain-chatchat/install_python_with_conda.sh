...
# Install BigDL LLM
$script_dir/python-occlum/bin/pip install --pre --upgrade ipex-llm[all]
$script_dir/python-occlum/bin/pip install torch==2.1.2 --index-url https://download.pytorch.org/whl/cpu
$script_dir/python-occlum/bin/pip install torchvision==0.16.2 torchaudio==2.1.2