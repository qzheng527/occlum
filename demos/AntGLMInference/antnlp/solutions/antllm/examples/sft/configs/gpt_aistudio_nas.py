...
TRAIN_DATA = "/workspace/chatgpt/data/text_extraction_train.jsonl"
TEST_DATA = "/workspace/chatgpt/data/text_extraction_test.jsonl"
PRETRAINED_MODEL_NAME_OR_PATH = "/workspace/chatgpt/pretrained_models/bloom-560m"
