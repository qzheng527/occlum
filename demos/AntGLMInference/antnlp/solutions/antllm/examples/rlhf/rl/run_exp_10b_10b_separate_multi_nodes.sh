...
rl_model_path=/mnt/xiaohao.wzh/sft/AntGLM-10B-SFT-Detoxcity-20230602
rw_model_path=/mnt/xiaohao.wzh/rm/model/rw_model/glm-10B-SFT-Detoxcity-20230602-rm-v8_k6_toxicity_100k-use_mean-no_position-bf16
output_dir=/mnt/xiaohao.wzh/rlhf/model/ckpt_10B-SFT-Detoxcity-20230602_10B-SFT-Detoxcity-20230602-rm-v8_k6_toxicity_100k-use_mean-no_position-bf16-separate-detoxicity-11-nodes
...
accelerate launch \
  ...
  --prompt_path /mnt/xiaohao.wzh/rlhf/data/rl_v10_toxic.csv \
  --exp_cfg_path exps/exp_10b_10b_separate_multi_nodes.yml \
  --save_dir ${output_dir} \
  --log_dir ${log_dir} \
  --mask_type '[gMASK]' \
  --rw_device $RM_DEVICE \
