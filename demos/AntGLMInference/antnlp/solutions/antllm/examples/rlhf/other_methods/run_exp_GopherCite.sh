...
rl_model_path=/ossfs/workspace/rlhf_v2_1500
rw_model_path=/ossfs/workspace/model/multi_doc_model/antglm-5b-sft/checkpoint-2000
model_name=glm-10b-5b-GopherCite-v2

output_dir=/ossfs/workspace/model/GopherCite-v2/antglm-10b-sft
...
accelerate launch \
  ...
  --prompt_path /ossfs/workspace/data/RL/GopherCite_infer_data.csv \
  --exp_cfg_path ./exps/exp_10b_5b_GopherCite.yml \
  --save_dir ${output_dir} \
  --log_dir ${log_dir} \
  --mask_type '[sMASK]' \
  --num_head 4
