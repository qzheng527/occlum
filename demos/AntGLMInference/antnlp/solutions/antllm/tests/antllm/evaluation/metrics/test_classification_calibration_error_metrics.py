...
from solutions.antllm.antllm.evaluation.metrics.classification.calibration_metrics import ECE
...
class TestMetric(TestCase):
    ...
    def test_metric(self):
        test = ECE()
        self.assertEqual(test.compute(self.predictions,
                                      self.references,
                                      self.extras)['estimated calibration error'], 6.67)
