...
def get_fa_version():
    ...
    try:
        ...
        import flash_attn
        if hasattr(flash_attn, '__version__') and version.parse(flash_attn.__version__) >= version.parse("2.0.0"):
            return 'fa2'
        return 'fa1'
    ...
    def forward(
        ...
        if fa_version == 'fa2':
            ...
            attn_output = flash_attn_func(
                ...
                value_states.transpose(1, 2), causal=True, dropout_p=0
            )
            ...
            attn_output = flash_attn_with_mask_bias(
                query_states.transpose(1, 2), key_states.transpose(1, 2),
                value_states.transpose(1, 2), dropout_p=0, causal=True
            )
            attn_output = attn_output.transpose(1, 2)
        else:
            ...
            if attention_mask is not None:
                attention_mask = attention_mask.expand(bsz, 
