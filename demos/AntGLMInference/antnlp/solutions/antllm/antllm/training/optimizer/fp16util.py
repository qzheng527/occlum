...
def prep_param_lists(model, flat_master=False):
    ...
    Args:
        ...
        Flatten the master parameters into a single tensor, as a performance optimization.
    Returns:
        A tuple (``model_params``, ``master_params``). ``model_params`` is
        a list of the model's parameters for later use with :func:`model_grads_to_master_grads`
        and :func:`master_params_to_model_params`.  ``master_params`` is a list of FP32 master gradients.
    ...
    .. warning::
        ...
        If the model has parameters of different types, use ``flat_master=False``,
    ...
    if flat_master:
        ...
        master_params = [param.clone().float().detach()
