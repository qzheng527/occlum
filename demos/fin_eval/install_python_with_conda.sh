...
$script_dir/python-occlum/bin/pip install --pre --upgrade bigdl-llm[all]
$script_dir/python-occlum/bin/pip install accelerate tiktoken einops transformers_stream_generator \
        sentencepiece pandas scikit-learn==1.3.0